...
class GStreamerDetectionApp(GStreamerApp):
    ...
    def get_pipeline_string(self):
        ...
        tcp_pipeline = 'tcpclientsink name=hailo_display host=localhost port=8000  sync=false text-overlay=false signal-fps-measurements=true'
        pipeline_string = (
            f'{source_pipeline} '
